...
<body>
	...
	<table>
		...
		<c:forEach var="i" items="${viewBugsList}" varStatus="j">
			<tr>
				<td>${ j.count }</td>
				<td>${ i.bugDate }</td>
				<td>${ i.bugName }</td>
				...
				<td><c:if test="${i.bugStatus eq 'ONGOING'}">
						<span style="color: #FF9800; font-weight: bold"><i
							class="mdi mdi-dots-horizontal-circle"></i></span>
				...
				<td><a
					style="color: #03A9F4; font-weight: bolder; font-size: 25px"
					href="openBug?bugId=${i.bugId}"><i
						class="mdi mdi-circle-outline"
						style="color: #03A9F4; font-weight: bold;"></i></a> | <a
					style="color: #FF9800; font-weight: bolder; font-size: 25px"
					href="ongoingBug?bugId=${i.bugId}"><i
						class="mdi mdi-dots-horizontal-circle"
						style="color: #FF9800; font-weight: bold;"></i></a> | <a
					style="color: #8BC34A; font-weight: bolder; font-size: 25px"
					href="completeBug?bugId=${i.bugId}"><i
						class="mdi mdi-check-circle"
						style="color: #8BC34A; font-weight: bold;"></i></a></td>
			</tr>
		</c:forEach>
	</table>
