...
<body>
	...
	<div class="form-container">
		...
		<f:form method="get" action="insertEffort"
			modelAttribute="manageEffortVO">
			<h2>${formName}</h2>
			<c:if test="${param.op eq 'true'}">
				<p style="color: green; text-align: center;">Operation Successful!</p>
			</c:if>
			<f:hidden path="effortId"/>
			<label for="effortName">Effort Name</label>
			<f:input type="text" id="effortName" placeholder="Effort Name"
				path="effortName" required="true" />

			<label for="effortDescription">Effort Description</label>
			<f:textarea id="effortDescription"
				placeholder="Enter Effort Description here..."
				path="effortDescription" required="true" />

			<label for="effortTimeHours">Hours</label>
			<f:input type="number" id="effortTimeHours"
				placeholder="Enter Time in Hours" path="effortTimeHours" min="0"
				max="24" required="true" />

			<label for="effortTimeMinutes">Minutes</label>
			<f:input type="number" id="effortTimeMinutes" placeholder="Email"
				path="effortTimeMinutes" min="0" max="59" required="true" />
