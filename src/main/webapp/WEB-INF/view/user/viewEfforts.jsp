...
<body>
	...
	<table>
		...
		<c:forEach var="i" items="${viewEffortList}" varStatus="j">
			<tr>
				<td>${ j.count }</td>
				<td>${ i.effortDate }</td>
				<td>${ i.effortName }</td>
				...
				<td><c:if test="${i.effortStatus eq 'PENDING'}">
						<span style="color: orange; font-weight: bold"><i
				...
				<td><a
					style="color: #2196F3 ; font-weight: bolder; font-size: 25px"
					href="editEffort?effortId=${i.effortId}"><i
						class="mdi mdi-pencil-circle"
						style="color: #2196F3 ; font-weight: bold;"></i></a> | <a
					style="color: #FF5252 ; font-weight: bolder; font-size: 25px"
					href="deleteEffort?effortId=${i.effortId}"><i
						class="mdi mdi-delete" style="color: #FF5252 ; font-weight: bold;"></i></a>
				</td>
			</tr>
		</c:forEach>
	</table>
